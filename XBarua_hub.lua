...
local Window = OrionLib:MakeWindow({Name = "X-Barua hub", HidePremium = false, IntroText = "MinGaming Library", SaveConfig = true, ConfigFolder = "Min Gaming Hub"})
----------Tab-----------------------
